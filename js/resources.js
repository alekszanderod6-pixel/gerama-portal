...
function fileIcon(filename) {
  ...
  if (ext === "pdf")  return "ð";
  if (ext === "pptx" || ext === "ppt") return "ð";
  if (ext === "mp4")  return "ð¬";
  if (ext === "jpg" || ext === "jpeg" || ext === "png") return "ð¼ï¸";
  return "ð";
}
...
function toggleBookmark(url, name, btn) {
  ...
  if(idx >= 0) {
    ...
    toast.textContent = 'ð Bookmarked: '+name.substring(0,40);
...
const materialsDB = {
  ...
  L100: {
    ...
    "French": {
      ...
      books: [
        ...
        { name: "Les Pays et NationalitÃ©s",                file: "l100/semester-1/french/book/les-pays-nationalitÃ©.pdf" },
        { name: "PassÃ© ComposÃ© (PPT)",                     file: "l100/semester-1/french/book/passe-compose.ppt" }
      ],
      pastq:  [],
      videos: []
    },
  ...
  L200: {
    ...
    "French": {
      ...
      slides: [],
      books: [
        { name: "PassÃ© ComposÃ© (PPT)",                     file: "l200/semester-1/french/passe-compose.ppt" }
      ],
      pastq:  [],
      videos: []
    },
